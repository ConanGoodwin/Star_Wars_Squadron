...
Command: npx gltfjsx@6.2.16 diceDefense.glb 
*/
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('../src/components/diceDefense.glb')
...
useGLTF.preload('../src/components/diceDefense.glb')
